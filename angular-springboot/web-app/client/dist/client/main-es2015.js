...
let GlobalErrorHandler = class GlobalErrorHandler {
    ...
    handleError(error) {
        const errorService = this.injector.get(_service_error_service__WEBPACK_IMPORTED_MODULE_4__["ErrorService"]);
        const logger = this.injector.get(_service_logging_service__WEBPACK_IMPORTED_MODULE_5__["LoggingService"]);
        const notifier = this.injector.get(_service_notification_service__WEBPACK_IMPORTED_MODULE_2__["NotificationService"]);
        let message;
        let stackTrace;
